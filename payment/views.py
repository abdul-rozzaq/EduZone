...
from core.models import LevelPurchase
...
class PaymentViewSet(GenericViewSet):
    ...
    def verify_payment(self, request, *args, **kwargs):
        ...
        status_code, response = 200, {"error_code": 0}
        ...
        # status_code, response = payment_with_token(payment.token, payment.level, payment_id=payment.pk)
        status_code, response = 200, {"error_code": 0}
